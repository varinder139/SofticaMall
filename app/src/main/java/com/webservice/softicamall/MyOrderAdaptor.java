...
public class MyOrderAdaptor extends RecyclerView.Adapter<MyOrderAdaptor.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyOrderAdaptor.ViewHolder holder, int position) {
        ...
        String resource = myOrderItemModelList.get(position).getProdutImage();
        ...
        switch (orderStatus) {
            ...
            case "Packed":
                ...
                break;
            case "Shipped":
                date = myOrderItemModelList.get(position).getShifftDate();
                break;
            case "Delivered":
                date = myOrderItemModelList.get(position).getDeliverDate();
                break;
            case "Cancelled":
                date = myOrderItemModelList.get(position).getCancelledDate();
                break;
            default: date = myOrderItemModelList.get(position).getCancelledDate();
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView produtTitle, deliveryStatus;
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            deliveryIndicator = itemView.findViewById(R.id.order_indiator);
            produtTitle = itemView.findViewById(R.id.order_product_title);
        ...
        private void setData(String recources, String title, String orderStatus, Date date, final int rating, final String productID, final int position) {
            Glide.with(itemView.getContext()).load(recources).into(productImage);
           // productImage.setImageResource(recources);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent oderDetailIntent = new Intent(itemView.getContext(), OrderDetailsActivity.class);
                    oderDetailIntent.putExtra("Position",position);
                    itemView.getContext().startActivity(oderDetailIntent);
                }
            });
