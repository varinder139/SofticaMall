...
public class SliderAdaptor extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        ConstraintLayout bannerontainer = view.findViewById(R.id.banner_container);
        bannerontainer.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(sliderModelList.get(position).getBackgroundColor())));
